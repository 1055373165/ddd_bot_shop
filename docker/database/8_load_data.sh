...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "mallbots" <<-EOSQL
    ...
    INSERT INTO stores.stores (id, name, location, participating) 
        VALUES ('ce9e26cd-d861-4b74-862f-06e0825c7af3', 'smy Books', 'West Upper Level', true);
    
    INSERT INTO stores.products (id, store_id, name, description, sku, price)
    VALUES ('7667e2f05-b10a-475c-baff-2cea8a86d8df', 'ce9e26cd-d861-4b74-862f-06e0825c7af3', 'smy study Golang', '', '111', 99.99);

    INSERT INTO customers.customers (id, name, sms_number, enabled)
        VALUES ('fff2d41a-a485-4008-b578-747732ae1089', 'Buyer #2', '777-1212', true);
EOSQL