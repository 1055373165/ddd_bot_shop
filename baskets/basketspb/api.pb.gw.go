...
func request_BasketService_GetBaskets_0(ctx context.Context, marshaler runtime.Marshaler, client BasketServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetBasketsRequest
	var metadata runtime.ServerMetadata

	msg, err := client.GetBaskets(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_BasketService_GetBaskets_0(ctx context.Context, marshaler runtime.Marshaler, server BasketServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetBasketsRequest
	var metadata runtime.ServerMetadata

	msg, err := server.GetBaskets(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterBasketServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BasketServiceServer) error {
	...
	mux.Handle("GET", pattern_BasketService_GetBaskets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/basketspb.BasketService/GetBaskets", runtime.WithHTTPPathPattern("/api/baskets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_BasketService_GetBaskets_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_BasketService_GetBaskets_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBasketServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BasketServiceClient) error {
	...
	mux.Handle("GET", pattern_BasketService_GetBaskets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/basketspb.BasketService/GetBaskets", runtime.WithHTTPPathPattern("/api/baskets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_BasketService_GetBaskets_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_BasketService_GetBaskets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "baskets"}, ""))
)
...
var (
	...
	forward_BasketService_GetBaskets_0 = runtime.ForwardResponseMessage
)
