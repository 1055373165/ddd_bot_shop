...
const (
	...
	BasketService_GetBaskets_FullMethodName     = "/basketspb.BasketService/GetBaskets"
)
...
type BasketServiceClient interface {
	...
	GetBaskets(ctx context.Context, in *GetBasketsRequest, opts ...grpc.CallOption) (*GetBasketsResponse, error)
}
...
func (c *basketServiceClient) GetBaskets(ctx context.Context, in *GetBasketsRequest, opts ...grpc.CallOption) (*GetBasketsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBasketsResponse)
	err := c.cc.Invoke(ctx, BasketService_GetBaskets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BasketServiceServer interface {
	...
	GetBaskets(context.Context, *GetBasketsRequest) (*GetBasketsResponse, error)
...
func (UnimplementedBasketServiceServer) GetBaskets(context.Context, *GetBasketsRequest) (*GetBasketsResponse, error) {
...
func _BasketService_GetBaskets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBasketsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BasketServiceServer).GetBaskets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BasketService_GetBaskets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BasketServiceServer).GetBaskets(ctx, req.(*GetBasketsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BasketService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BasketService_GetBaskets_Handler,
		},
	},
