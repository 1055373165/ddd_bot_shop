...
const (
	DepotService_GetShoppingLists_FullMethodName     = "/depotpb.DepotService/GetShoppingLists"
...
type DepotServiceClient interface {
	GetShoppingLists(ctx context.Context, in *GetShoppingListsRequest, opts ...grpc.CallOption) (*GetShoppingListsResposne, error)
...
func (c *depotServiceClient) GetShoppingLists(ctx context.Context, in *GetShoppingListsRequest, opts ...grpc.CallOption) (*GetShoppingListsResposne, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetShoppingListsResposne)
	err := c.cc.Invoke(ctx, DepotService_GetShoppingLists_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DepotServiceServer interface {
	GetShoppingLists(context.Context, *GetShoppingListsRequest) (*GetShoppingListsResposne, error)
...
func (UnimplementedDepotServiceServer) GetShoppingLists(context.Context, *GetShoppingListsRequest) (*GetShoppingListsResposne, error) {
...
func _DepotService_GetShoppingLists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetShoppingListsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DepotServiceServer).GetShoppingLists(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DepotService_GetShoppingLists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DepotServiceServer).GetShoppingLists(ctx, req.(*GetShoppingListsRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _DepotService_GetShoppingLists_Handler,
		},
		{
