...
type NotificationsServiceClient interface {
	NotifyOrderCreated(ctx context.Context, in *NotifyOrderCreatedRequset, opts ...grpc.CallOption) (*NotifyOrderCreatedResponse, error)
...
func (c *notificationsServiceClient) NotifyOrderCreated(ctx context.Context, in *NotifyOrderCreatedRequset, opts ...grpc.CallOption) (*NotifyOrderCreatedResponse, error) {
...
type NotificationsServiceServer interface {
	NotifyOrderCreated(context.Context, *NotifyOrderCreatedRequset) (*NotifyOrderCreatedResponse, error)
...
func (UnimplementedNotificationsServiceServer) NotifyOrderCreated(context.Context, *NotifyOrderCreatedRequset) (*NotifyOrderCreatedResponse, error) {
...
func _NotificationsService_NotifyOrderCreated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NotifyOrderCreatedRequset)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationsServiceServer).NotifyOrderCreated(ctx, req.(*NotifyOrderCreatedRequset))
	}
